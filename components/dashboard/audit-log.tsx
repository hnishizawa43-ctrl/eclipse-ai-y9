...
const auditEntries = [
  ...
  {
    id: "AUD-040",
    action: "Non-Compliance Alert Resolved",
    regulation: "US Executive Order",
    user: "admin@eclipse.ai",
  ...
  {
    id: "AUD-038",
    action: "Full Audit Report Exported",
  ...
  {
    id: "AUD-037",
    action: "Bias Assessment Completed",
    regulation: "Japan AI Guidelines",
    user: "system",
    ...
    <div className="rounded-lg border border-border bg-card p-5">
      <div className="mb-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-muted-foreground">Recent compliance activities</p>
        </div>
