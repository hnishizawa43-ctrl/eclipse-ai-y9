  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-background px-4 overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div
          className="absolute -top-32 -left-32 h-96 w-96 rounded-full opacity-20 blur-3xl animate-orb-1"
          style={{ background: "oklch(0.62 0.18 260)" }}
        />
        <div
          className="absolute -bottom-32 -right-32 h-80 w-80 rounded-full opacity-15 blur-3xl animate-orb-2"
          style={{ background: "oklch(0.65 0.17 155)" }}
        />
        <div
          className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 h-64 w-64 rounded-full opacity-10 blur-3xl animate-orb-1"
          style={{ background: "oklch(0.65 0.2 310)", animationDelay: "5s" }}
        />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md animate-slide-up-fade">
        ...
        <div className="mb-8 flex flex-col items-center gap-3">
          <div className="relative flex h-14 w-14 items-center justify-center rounded-xl bg-primary shadow-lg">
            <Shield className="h-7 w-7 text-primary-foreground" />
            <div className="absolute inset-0 rounded-xl animate-glow-pulse" style={{ boxShadow: "0 0 30px var(--glow-primary)" }} />
          </div>
        ...
        <Card className="glass-card border-border/30">
          <Tabs defaultValue="login">
            ...
            <CardContent>
              {error && (
                <div className="mb-4 rounded-md bg-destructive/10 px-3 py-2 text-sm text-destructive border border-destructive/20 animate-slide-up-fade">
                  {error}
                </div>
              )}
              ...
              <TabsContent value="login" className="mt-0">
                ...
                <form onSubmit={handleLogin} className="flex flex-col gap-4">
                  <div className="flex flex-col gap-2">
                    ...
                    <Input
                      ...
                      className="bg-secondary/50 border-border/50 transition-all duration-300 focus:border-primary/50 focus-glow"
                      autoComplete="email"
                      required
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                    ...
                    <div className="relative">
                      <Input
                        ...
                        className="bg-secondary/50 border-border/50 pr-10 transition-all duration-300 focus:border-primary/50 focus-glow"
                  ...
                  <Button type="submit" className="w-full mt-2 hover-lift" disabled={isSubmitting}>
                ...
                <Button
                  type="button"
                  variant="outline"
                  className="w-full gap-2 border-border/50 hover:bg-secondary/50 transition-all duration-300"
